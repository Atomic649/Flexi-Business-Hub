  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: IntroductionScreen(
        ...
        pages: [
          PageViewModel(
            title: "เห็นภาพรวมทุกแพตฟอร์ม",
            body:
                "รวมรายได้และค่าใช้จ่ายทุกแพตฟอร์มไว้ในที่เดียว คาดการณ์รายได้ ลดย่อนค่าใช้จ่าย ให้การยื่นภาษีเป็นเรื่องง่ายและประหยัดกว่าที่เคย",
            image: Padding(
          ...
          PageViewModel(
            title: "Cash Flow",
            body:
                "คาดการณ์และบริหารเงินสด หมดปัญหาขายดีมากแต่เจ๊ง ไม่รู้ว่าเงินในมือหายไปไหน",
            image: Padding(
              padding: const EdgeInsets.only(top: 100.0),
          ...
          PageViewModel(
            title: "สร้างคอนเนคชั่นทางธุรกิจ",
            body:
                "ให้เครดิต สร้างความน่าเชื่อถือ ช่องทางติิดต่อ และข่าวสารที่เชื่อถือได้ เพราะเรารูว่าเวลาของคุณมีค่าแต่ไหน",
            image: Padding(
              padding: const EdgeInsets.only(top: 100.0),
