...
class GoogleBox extends StatefulWidget {
  ...
  @override
  State<GoogleBox> createState() => _GoogleBoxState();
}

class _GoogleBoxState extends State<GoogleBox> {
  double boxHeightGoogle = 160;
  double boxWidthGoogle = 200;
    ...
    return Stack(
        ...
        children: [
          socialMediaContainer(
            height: boxHeightGoogle,
            width: boxWidthGoogle,
          ...
          // google
          socialBoxPosition(
              ontap: _hideGoogleBox,
              onDoubleTap: _showGoogleBox,
              child: Container(
